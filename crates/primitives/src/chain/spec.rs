...
/// The BSC QA net (rialto) spec
#[cfg(feature = "bsc")]
pub static BSC_QA: Lazy<Arc<ChainSpec>> = Lazy::new(|| {
    ChainSpec {
        chain: Chain::from_id(714),
        // need to be modified before test
        genesis: serde_json::from_str(include_str!("../../res/genesis/bsc_qa.json"))
            .expect("Can't deserialize BSC QA genesis json"),
        genesis_hash: Some(b256!(
            "6d3c66c5357ec91d5c43af47e234a939b22557cbb552dc45bebbceeed90fbe34"
        )),
        paris_block_and_final_difficulty: Some((0, U256::from(0))),
        hardforks: BTreeMap::from([
            ...
            (Hardfork::Ramanujan, ForkCondition::Block(0)),
            (Hardfork::Niels, ForkCondition::Block(0)),
            (Hardfork::MirrorSync, ForkCondition::Block(1)),
            (Hardfork::Bruno, ForkCondition::Block(1)),
            (Hardfork::Euler, ForkCondition::Block(2)),
            (Hardfork::Gibbs, ForkCondition::Block(3)),
            (Hardfork::Nano, ForkCondition::Block(3)),
            (Hardfork::Moran, ForkCondition::Block(4)),
            (Hardfork::Planck, ForkCondition::Block(5)),
            (Hardfork::Luban, ForkCondition::Block(6)),
            (Hardfork::Plato, ForkCondition::Block(7)),
            (Hardfork::Berlin, ForkCondition::Block(8)),
            (Hardfork::London, ForkCondition::Block(8)),
            (Hardfork::Hertz, ForkCondition::Block(8)),
            (Hardfork::HertzFix, ForkCondition::Block(8)),
            (Hardfork::Shanghai, ForkCondition::Timestamp(0)),
            (Hardfork::Kepler, ForkCondition::Timestamp(0)),
            (Hardfork::Feynman, ForkCondition::Timestamp(0)),
            (Hardfork::FeynmanFix, ForkCondition::Timestamp(0)),
            (Hardfork::Cancun, ForkCondition::Timestamp(0)),
            (Hardfork::Haber, ForkCondition::Timestamp(0)),
        ]),
        deposit_contract: None,
        base_fee_params: BaseFeeParamsKind::Constant(BaseFeeParams::new(1, 1)),
        prune_delete_limit: 3500,
