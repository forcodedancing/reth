    ...
    ($target:ty $(where [$($generics:tt)*])?) => {
        $crate::providers::state::macros::delegate_impls_to_as_ref!(
            ...
            StateRootProvider $(where [$($generics)*])? {
                ...
                fn state_root_from_nodes_caches_with_updates(&self,  nodes: reth_trie::updates::TrieUpdates, state: reth_trie::HashedPostState, prefix_sets: reth_trie::prefix_set::TriePrefixSetsMut, hashed_cache: &'static dyn reth_trie::cache::TrieCache<reth_primitives::B256, reth_primitives::Account, (reth_primitives::B256, reth_primitives::B256), reth_primitives::U256>, trie_cache: &'static dyn reth_trie::cache::TrieCache<reth_trie::Nibbles, reth_trie::BranchNodeCompact, (reth_primitives::B256, reth_trie::Nibbles), reth_trie::BranchNodeCompact>) -> reth_storage_errors::provider::ProviderResult<(reth_primitives::B256, reth_trie::updates::TrieUpdates)>;
            }
